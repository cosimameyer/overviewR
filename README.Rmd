...
The output of `overview_tab` and `overview_crosstab` are also compatible with other packages such as [```xtable```](https://CRAN.R-project.org/package=xtable), [```flextable```](https://cran.r-project.org/web/packages/flextable/vignettes/overview.html), or [`knitr`](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html).
...
The outputs of `overview_tab` and `overview_crosstab` are also compatible with other functions such as [`xtable`](https://CRAN.R-project.org/package=xtable), [`flextable`](https://cran.r-project.org/web/packages/flextable/vignettes/overview.html), or [`kable`](https://bookdown.org/yihui/rmarkdown-cookbook/kable.html) from [`knitr`](https://yihui.org/knitr/).
