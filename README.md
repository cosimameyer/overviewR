...
# Countries
countries <-
  c(rep("RWA", 4), rep("AGO", 8), rep("BEN", 2), rep("GBR", 5), rep("FRA", 3)) 
...
# GDP
gdp <-
  runif(22, 10000, 40000) # Add a numeric vector for additional data (randomly generated)

# Population size
population <-
  runif(22, 100, 50000)# Add another numeric vector for additional data (randomly generated)
